<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="P12.login" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%; height: 246px;">
        <tr>
            <td bgcolor="#7FFFD4" colspan="2" align="center"><b>Login</b></td>
        </tr>
        <tr>
